...
const HeadphoneItems = ({ index, categoryImage, name, description }) => {
  return (
    <>
      {index % 2 === 0 ? (
        <div className="categoryItems">
          <article className="categoryItems__container">
        ...
        <div className="categoryItems">
          <article className="categoryItems__container">
            ...
            <div className="categoryItems-preview grid-right-2">
              <picture>
                {/* mobile image */}
                <source
                  srcSet={categoryImage.mobile}
